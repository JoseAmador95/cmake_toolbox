...
Policy_Register(
    ...
    WARNING "This policy changes behavior significantly. Please test thoroughly."
)
Policy_Register(
    NAME MY0002
    ...
    WARNING "May cause compilation issues|with older compilers."
)
...
message(
    STATUS
    "=== Try with explicit MAXIMUM (Policy_Version MINIMUM 1.0 MAXIMUM 2.5): policies in range set to NEW ==="
)
...
if(NOT v1 STREQUAL NEW)
    message(
        SEND_ERROR
        "Policy_Get(MY0001) returned OLD instead of NEW (1.0 is in range [1.0, 2.5])"
    )
endif()
...
if(NOT v2 STREQUAL NEW)
    message(
        SEND_ERROR
        "Policy_Get(MY0002) returned OLD instead of NEW (2.0 is in range [1.0, 2.5])"
    )
endif()
...
if(NOT v3 STREQUAL OLD)
    message(
        SEND_ERROR
        "Policy_Get(MY0003) returned NEW instead of OLD (3.1 is outside range [1.0, 2.5])"
    )
endif()
