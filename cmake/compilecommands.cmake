...
function(compile_commands_trim)
    ...
    set(JQ_SCRIPT ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/prune_compile_commands/prune_compile_commands.jq)
    ...
    add_custom_command(
        OUTPUT ${ARG_OUTPUT}
        COMMAND ${JQ_EXECUTABLE} -f ${JQ_SCRIPT} ${ARG_INPUT} > ${ARG_OUTPUT}
        DEPENDS ${ARG_INPUT} ${JQ_SCRIPT}
