...
execute_process(
    ...
    set(wrapper_path "${CMAKE_CURRENT_LIST_DIR}/CTestFullOutput.cmake")
    foreach(line ${output})
        string(STRIP "${line}" test_name)
        if(test_name)
            string(REPLACE ";" "\\;" test_name_escaped "${test_name}")
            string(
                APPEND script
                "add_test(\"${ARG_TEST_SUITE}/${test_name}\" \"${CMAKE_COMMAND}\" -D \"TEST_COMMAND=${ARG_TEST_EXECUTABLE}\" -D \"TEST_ARGS=-f\\;${test_name_escaped}\" -D \"TEST_WORKING_DIR=${ARG_TEST_WORKING_DIR}\" -P \"${wrapper_path}\")\n"
            )
