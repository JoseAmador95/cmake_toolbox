...
function(test_blacklist_removes_gcc_modules_flags)
    ...
    set(build_dir "${TEST_ROOT}/gcc_modules/build")
    file(MAKE_DIRECTORY "${src_dir}")
...
"
    ...
    if(trimmed_content MATCHES "-Wduplicated-branches")
        message(STATUS "  - GCC -Wduplicated-branches should be removed by blacklist")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
    endif()
    if(trimmed_content MATCHES "-Wuseless-cast")
        message(STATUS "  - GCC -Wuseless-cast should be removed by blacklist")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
    endif()
    if(NOT trimmed_content MATCHES "-DFOO=1")
        message(STATUS "  - Define flag -DFOO=1 should be preserved")
...
"
    ...
    if(NOT trimmed_content MATCHES "-isystem/sys")
        message(STATUS "  - System include flag -isystem/sys should be preserved")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
    endif()
    if(NOT trimmed_content MATCHES "-x c\\+\\+")
        message(STATUS "  - Language flag -x c++ should be preserved")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
    endif()
