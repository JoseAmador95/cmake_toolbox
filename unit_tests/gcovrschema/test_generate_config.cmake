...
set(ERROR_COUNT 0)
set(TEST_ROOT "${CMAKE_BINARY_DIR}/gcovrschema_generate_test")
...
")
    ...
    if(EXISTS "${config_file}")
        ...
        string(FIND "${config_content}" "html" has_html)
        string(FIND "${config_content}" "print-summary" has_summary)
...
function(run_all_tests)
    ...
    if(ERROR_COUNT GREATER 0)
        message(FATAL_ERROR "GcovrSchema GenerateConfigFile tests failed with ${ERROR_COUNT} error(s)")
    else()
