...
function(test_detect_unsupported_version)
    ...
    if(NOT detected_version STREQUAL "")
        message(STATUS "  ✗ Expected empty string for unsupported v3.0.0, got '${detected_version}'")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
        return()
    endif()
...
function(test_detect_from_tag_v2_5_3)
    ...
    if(NOT detected_version STREQUAL "")
        message(STATUS "  ✗ Expected empty string for unsupported v2.5.3, got '${detected_version}'")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
        return()
    endif()
...
function(test_detect_nonexistent_executable)
    ...
    if(NOT detected_version STREQUAL "2.6")
        message(STATUS "  ✗ Expected '2.6' when exe missing + tag 'v2.6.0', got '${detected_version}'")
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
        return()
    endif()
