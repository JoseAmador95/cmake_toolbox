# Test: CMockSchema_GetSupportedVersions
...
function(test_returns_non_empty_list)
    message(STATUS "Test 1: CMockSchema_GetSupportedVersions returns non-empty list")
...
function(test_contains_expected_version)
    message(STATUS "Test 2: Supported versions contains '2.6'")
    ...
    message(STATUS "  ✓ Version 2.6 found in supported versions")
endfunction()
...
function(test_output_variable_set)
    ...
    CMockSchema_GetSupportedVersions(my_output)
...
function(run_all_tests)
    message(STATUS "=== CMockSchema_GetSupportedVersions Tests ===")
    ...
    if(ERROR_COUNT GREATER 0)
        message(FATAL_ERROR "CMockSchema GetSupportedVersions tests failed with ${ERROR_COUNT} error(s)")
    else()
        message(STATUS "All CMockSchema GetSupportedVersions tests PASSED")
    endif()
endfunction()
