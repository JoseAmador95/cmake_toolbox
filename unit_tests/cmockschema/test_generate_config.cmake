...
")
    ...
    if(EXISTS "${config_file}")
        ...
        string(FIND "${yaml_content}" ":cmock:" has_cmock_key)
...
")
    ...
    if(EXISTS "${config_file}")
        ...
        string(FIND "${yaml_content}" "mock_prefix" has_mock_prefix)
...
")
    ...
    if(EXISTS "${config_file}")
        ...
        string(FIND "${yaml_content}" ":plugins:" has_plugins)
...
")
    ...
    if(EXISTS "${config_file}")
        ...
        string(FIND "${yaml_content}" "custom_mock_" has_custom_prefix)
...
function(run_all_tests)
    ...
    if(ERROR_COUNT GREATER 0)
        message(FATAL_ERROR "CMockSchema GenerateConfigFile tests failed with ${ERROR_COUNT} error(s)")
    else()
