...
set(ERROR_COUNT 0)
set(TEST_ROOT "${CMAKE_BINARY_DIR}/integration_sanitizer_combos")
...
function(test_sanitizer_combo NAME ASAN UBSAN LSAN EXPECTED_FLAGS)
...
")
    ...
    foreach(flag ${EXPECTED_FLAGS})
        string(FIND "${output}" "${flag}" has_flag)
        if(has_flag EQUAL -1)
