...
set(ERROR_COUNT 0)
set(TEST_DIR "${CMAKE_TOOLBOX_TEST_ARTIFACTS_ROOT}/clangformat_edge_test")
...
function(test_special_filenames)
    ...
    ClangFormat_CollectFiles(SPECIAL_FILES SOURCE_DIRS special)
...
function(test_command_creation_edge_cases)
    ...
    ClangFormat_CreateCommand(EMPTY_COMMAND EXECUTABLE clang-format MODE FORMAT FILES "")
    ...
    ClangFormat_CreateCommand(NO_STYLE_COMMAND EXECUTABLE clang-format MODE FORMAT FILES "test.c")
...
function(test_exclusion_edge_cases)
    ...
    ClangFormat_CollectFiles(NO_EXCLUDE_RESULT SOURCE_DIRS exclude_test EXCLUDE_PATTERNS "")
