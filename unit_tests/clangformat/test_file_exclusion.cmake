...
set(ERROR_COUNT 0)
set(TEST_DIR "${CMAKE_TOOLBOX_TEST_ARTIFACTS_ROOT}/clangformat_exclusion_test")
...
function(test_wildcard_exclusion)
    ...
    if(filtered_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after wildcard exclusion, found ${filtered_count}"
        )
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
    endif()
...
function(test_directory_exclusion)
    ...
    if(no_gen_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after directory exclusion, found ${no_gen_count}"
        )
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
    endif()
...
function(test_multiple_exclusions)
    ...
    if(multi_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after multiple exclusions, found ${multi_count}"
        )
...
function(test_exclusion_with_custom_patterns)
    ...
    if(c_filtered_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} C files after exclusion, found ${c_filtered_count}"
        )
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
    endif()
