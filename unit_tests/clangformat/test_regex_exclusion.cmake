...
function(test_simple_regex_patterns)
    ...
    if(no_test_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after test exclusion, found ${no_test_count}"
        )
...
function(test_directory_regex_patterns)
    ...
    if(no_gen_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after generated exclusion, found ${no_gen_count}"
        )
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
    endif()
...
function(test_extension_regex_patterns)
    ...
    if(no_cpp_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after .cpp exclusion, found ${no_cpp_count}"
        )
        math(EXPR ERROR_COUNT "${ERROR_COUNT} + 1")
        set(ERROR_COUNT "${ERROR_COUNT}" PARENT_SCOPE)
    endif()
...
function(test_complex_regex_patterns)
    ...
    if(complex_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after complex exclusion, found ${complex_count}"
        )
...
function(test_multiple_regex_patterns)
    ...
    if(multi_count EQUAL EXPECTED_COUNT)
        ...
        message(
            STATUS
            "  ✗ Expected ${EXPECTED_COUNT} files after multiple regex, found ${multi_count}"
        )
